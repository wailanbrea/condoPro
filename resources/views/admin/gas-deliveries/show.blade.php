...
<nav class="flex items-center gap-2 mb-xl text-on-surface-variant">
    ...
    <span class="material-symbols-outlined text-sm" data-icon="chevron_right">chevron_right</span>
    <a href="{{ route('gas-deliveries.index') }}" class="text-body-sm hover:text-primary transition-colors">Recepciones</a>
    <span class="material-symbols-outlined text-sm" data-icon="chevron_right">chevron_right</span>
...
<div class="flex justify-between items-end mb-lg">
    ...
    <a href="{{ route('gas-deliveries.index', ['condominium_id' => $gasDelivery->condominium_id]) }}" class="px-lg py-2 bg-white border border-outline-variant rounded-lg flex items-center gap-2 hover:bg-surface-container-low transition-colors">
